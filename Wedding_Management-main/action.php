...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['save_review'])) {
    $productName = "Sample Product"; // You can get this dynamically from your form
    $userName = $_POST['user_name'];
    $rating = $_POST['rating'];
    $review = $_POST['user_review'];

    // Prepare SQL statement to insert review
    $stmt = $con->prepare("INSERT INTO reviews (product_name, user_name, rating, review) VALUES (?, ?, ?, ?)");
    $stmt->bind_param('ssis', $productName, $userName, $rating, $review);
